...
[Botón2](buttonurl://google.com:same)""",
 ...
 • envía el /setlog que has puesto en el canal al grupo.""",
    ...
    "Invalid Chat ID provided!": "El ID del chat no es válido!",
    "You don't seem to be referring to a user.": "Parece que no te estás refiriendo a ningún usuario.",
    "I can't seem to find this user": "Parece que no puedo encontrar a este usuario.",
    "Yes": "Si",
    "No": "No",
    "Admin": "Administrador",
    "AFK": "Ausente (AFK)",
