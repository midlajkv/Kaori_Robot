...
[Botón2](buttonurl://google.com:same)""",
 ...
 • forward the /setlog to the group.""",
    ...
    "Get rekt": "Sie mk.",
    "Invalid Chat ID provided!": "Geçersiz sohbet kimliği!",
    "You don't seem to be referring to a user.": "Bu bir kullanıcıyı atıfta bulundurmuyor..",
    "I can't seem to find this user": "Bu kullancıyı bulamıyorum.",
    "Yes": "Evet",
    "No": "Hayır",
    "Admin": "Yönetici",
    "AFK": "Meşgul (AFK)",
